- [一. 代码规范](#一-代码规范)
  - [1.1. 集成 editorconfig 配置](#11-集成-editorconfig-配置)
  - [1.2. 使用 prettier 工具](#12-使用-prettier-工具)
  - [1.3. 使用 ESLint 检测](#13-使用-eslint-检测)
  - [1.4. git Husky 和 eslint](#14-git-husky-和-eslint)
  - [1.5. git commit 规范](#15-git-commit-规范)
    - [1.5.1. 代码提交风格](#151-代码提交风格)
    - [1.5.2. 代码提交验证](#152-代码提交验证)
- [二. 第三方库集成](#二-第三方库集成)
  - [2.1. vue.config.js 配置](#21-vueconfigjs-配置)
  - [2.2. vue-router 集成](#22-vue-router-集成)
  - [2.3. vuex 集成](#23-vuex-集成)
  - [2.4. element-plus 集成](#24-element-plus-集成)
    - [2.4.1. 全局引入](#241-全局引入)
    - [2.4.2. 局部引入](#242-局部引入)
  - [2.5. axios 集成](#25-axios-集成)
  - [2.6. VSCode 配置](#26-vscode-配置)
  - [2.7. css 初始化](#27-css-初始化)
